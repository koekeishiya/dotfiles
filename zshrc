...
export PATH=/opt/local/sbin:/opt/local/bin:/usr/local/bin:$PATH

# Path to your oh-my-zsh installation.
export ZSH=/Users/Koe/.oh-my-zsh
...
alias ebar='nvim "/Users/Koe/Library/Application Support/Übersicht/widgets"'
alias ll='ls -lh'
...
linecount() { find $1 -name "*.*" -print | xargs wc -l }
